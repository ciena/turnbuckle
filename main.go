...
import (
	...
	constraintcontrollers "github.com/ciena/turnbuckle/controllers/constraint"
...
func main() {
	...
	if err = (&constraintcontrollers.ConstraintPolicyReconciler{
	...
	if err = (&constraintcontrollers.ConstraintPolicyOfferReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&constraintcontrollers.ConstraintPolicyBindingReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
